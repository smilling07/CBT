		...
		<div class="row">
			...
			<div class="col-sm-4">
				<div class="pull-right">
					<a href="<?=base_url('soal/add')?>" class="btn bg-purple btn-flat btn-sm"><i class="fa fa-plus"></i> Buat Pilihan Ganda</a>
					<a href="<?=base_url('soal/buat_uraian')?>" class="btn bg-purple btn-flat btn-sm"><i class="fa fa-plus"></i> Buat Uraian</a>
